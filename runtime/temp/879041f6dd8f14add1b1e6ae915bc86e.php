<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:68:"D:\xampp\htdocs\tv\public/../application/admin\view\index\index.html";i:1508729410;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<div class="layui-layout layui-layout-admin"> <!-- 添加skin-1类可手动修改主题为纯白，添加skin-2类可手动修改主题为蓝白 -->
    ...
    <div class="layui-header my-header">
        <a href="index.html">
            ...
            <div class="my-header-logo">直播管理后台</div>
        </a>
